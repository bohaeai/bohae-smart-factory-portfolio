...
│
├── docs/                        # 거버넌스 & 도메인 지식
│   ├── AGENTS.md                # 공개용 작업 가이드
│   └── beverage_batch_domain_notes.md
│
└── evidence/                    # 현장 검증 사진 (EXIF/GPS 제거본)
    ├── ESP32 and BUP 50S.jpeg
    ├── FX6Y Autonics 116748.jpeg
    ├── Google Sheet 116748.jpeg
    └── Kiosk Retool.jpeg
```

> ⚠️ **참고**: 이 레포는 포트폴리오용 발췌본입니다. 비밀번호, 토큰, 공인 IP, 내부 도메인, 위치 메타데이터(EXIF GPS) 등 보안 항목은 제거했습니다.
...
### 데이터 집계 검증
![데이터 집계](evidence/Google%20Sheet%20116748.jpeg)

### 키오스크 초기 버전
![키오스크](evidence/Kiosk%20Retool.jpeg)
