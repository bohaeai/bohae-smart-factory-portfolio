...
| 상태 | 과제 |
|:---:|------|
| ✅ 완료 | IoT 카운터 1호기 파일럿 (116,748개 일치) |
| ✅ 완료 | MES/OPS 98페이지 + APS 엔진 + LIMS + EAM |
| ✅ 완료 | 3D 디지털 트윈 + AI Text2SQL/What-If |
| 🔄 진행 중 | B1~B4 라인 OT 데이터 수집 확장 (Coriolis, Magmeter, IO-Link) |
| 🔄 진행 중 | PLC 게이트웨이 연동 (Siemens S7-1200, Modbus TCP) |
| 📋 계획 | 사내 온프레미스 LLM + 공장 온톨로지 RAG |
| 📋 계획 | VFD 인버터 다단 제어 + 자동밸브 피드백 (Phase 3) |
